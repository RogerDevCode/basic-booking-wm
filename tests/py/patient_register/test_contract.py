...
async def test_patient_register_success() -> None:
    ...
    mock_db.fetch.side_effect = [
        ...
        [], # email lookup
        [{ # insert result
            "client_id": VALID_ID, "name": "Test Client", "email": "t@t.com",
            "phone": None, "telegram_chat_id": "123", "timezone": "UTC"
        }]
    ]
    ...
    with patch("f.patient_register.main.create_db_client", return_value=mock_db), \
