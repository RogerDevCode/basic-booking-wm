...
from f.internal.fsm_router._router_models import RouterInput, RouterResult
from f.internal.fsm_router._router_reminders import handle_reminders_config
...
@pytest.mark.asyncio
@patch("f.internal.fsm_router._router_reminders.run_reminder_config", new_callable=AsyncMock)
