...
async def test_provider_dashboard_success() -> None:
    ...
    mock_db.fetch.side_effect = [
        ...
        [{
            ...
            "status": "confirmed", "client_name": "Patient", "service_name": "Consult"
        }], # agenda
    ...
    with patch("f.web_provider_dashboard.main.create_db_client", return_value=mock_db), \
         patch("f.web_provider_dashboard.main.with_tenant_context", side_effect=mock_with_tenant):
        
        args = {"provider_user_id": VALID_ID, "date": "2026-05-01"}
