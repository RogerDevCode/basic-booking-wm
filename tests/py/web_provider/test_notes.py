...
async def test_provider_notes_create_success() -> None:
    ...
    mock_db.fetch.side_effect = [
        [{
            "note_id": "n1", "provider_id": VALID_ID, "booking_id": "b1", "client_id": "c1",
            "content_encrypted": "hex-data", "encryption_version": 1,
    ...
    with patch("f.web_provider_notes.main.create_db_client", return_value=mock_db), \
