...
from f.web_patient_bookings.main import main
...
async def test_patient_bookings_list_success() -> None:
    ...
    mock_db.fetch.side_effect = [
        ...
        [{
            "booking_id": "b1", "start_time": "2026-05-01T10:00:00Z", "end_time": "2026-05-01T10:30:00Z",
            "status": "confirmed", "cancellation_reason": None,
            "provider_name": "Dr. Smith", "provider_specialty": "Cardio", "service_name": "Consult"
        }],
        [{"count": 1}]
    ]
    ...
    with patch("f.web_patient_bookings.main.create_db_client", return_value=mock_db), \
