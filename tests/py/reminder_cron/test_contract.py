...
from f.reminder_cron.main import main
...
async def test_reminder_cron_success() -> None:
    ...
    mock_db.fetch.side_effect = [
        ...
        [{ # 24h window bookings
            "booking_id": "b1", "client_id": "c1", "provider_id": "p1",
            "start_time": "2026-05-01T10:00:00Z", "end_time": "2026-05-01T10:30:00Z",
            "status": "confirmed",
            "reminder_24h_sent": False, "reminder_2h_sent": False, "reminder_30min_sent": False,
            "client_telegram_chat_id": "123", "client_email": "t@t.com",
            "client_name": "Patient", "provider_name": "Dr", "service_name": "S",
