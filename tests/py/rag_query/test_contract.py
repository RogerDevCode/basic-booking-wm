...
from f.rag_query.main import main
...
async def test_rag_query_success() -> None:
    ...
    mock_db.fetch.return_value = [
        {"kb_id": "1", "category": "General", "title": "Horarios de Atención", "content": "Atendemos de Lunes a Viernes de 9 a 18 hrs."},
        {"kb_id": "2", "category": "Ubicación", "title": "Dirección", "content": "Estamos en Av. Providencia 1234, Santiago."},
    ]
    ...
    with patch("f.rag_query.main.create_db_client", return_value=mock_db), \
