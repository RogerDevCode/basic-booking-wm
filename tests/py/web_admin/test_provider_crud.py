...
async def test_admin_provider_list_success() -> None:
    ...
    mock_db.fetch.return_value = [{
        "id": "p1", "name": "Dr. Smith", "email": "s@s.com", "is_active": True,
        "created_at": "2026-05-01T10:00:00Z", "updated_at": "2026-05-01T10:00:00Z"
    }]

    async def mock_with_admin(db, op):
        return await op()

    with patch("f.web_admin_provider_crud.main.create_db_client", return_value=mock_db), \
