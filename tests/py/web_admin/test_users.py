...
from f.web_admin_users.main import main
...
async def test_admin_users_list_success() -> None:
    ...
    mock_db.fetch.side_effect = [
        ...
        [{
            "user_id": "u1", "full_name": "Test User", "email": "t@t.com",
            "rut": "1-9", "phone": "123", "role": "client", "is_active": True,
            "telegram_chat_id": None, "last_login": None, "created_at": "2026-05-01T10:00:00Z"
        }],
        [{"total": 1}]
    ]
    ...
    with patch("f.web_admin_users.main.create_db_client", return_value=mock_db), \
