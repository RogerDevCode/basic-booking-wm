...
async def test_admin_dashboard_success() -> None:
    ...
    mock_db.fetch.side_effect = [
        ...
        [{"total_users": 10, "total_bookings": 5, "total_revenue_cents": 1000, "active_providers": 2, "pending_bookings": 1}], # stats
    ...
    with patch("f.web_admin_dashboard.main.create_db_client", return_value=mock_db), \
