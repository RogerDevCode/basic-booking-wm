...
async def test_admin_tags_list_categories_success() -> None:
    ...
    mock_db.fetch.side_effect = [
        ...
        [{
            "category_id": "c1", "name": "Tags Medicas", "description": "D",
            "is_active": True, "sort_order": 1, "created_at": "2026-05-01T10:00:00Z",
            "tag_count": 5
        }]
    ]
    ...
    with patch("f.web_admin_tags.main.create_db_client", return_value=mock_db), \
