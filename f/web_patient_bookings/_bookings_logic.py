...
async def get_patient_bookings(db: DBClient, client_id: str, input_data: InputSchema) -> Result[BookingsResult]:
    try:
        ...
        count_query = query.replace("b.booking_id, b.start_time, b.end_time, b.status, b.cancellation_reason, p.name AS provider_name, p.specialty AS provider_specialty, s.name AS service_name", "COUNT(*)")
