...
from ._bookings_models import InputSchema, BookingsResult
from ._bookings_logic import resolve_client_id, get_patient_bookings
...
async def main(args: dict[str, Any]) -> Result[BookingsResult]:
    ...
    try:
        ...
        async def operation() -> Result[BookingsResult]:
            ...
            if err_id or not client_id: return fail(err_id or "client_not_found")
