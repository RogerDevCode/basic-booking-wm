...
async def get_valid_access_token(provider_id: str, current: TokenInfo, db: DBClient) -> Result[str]:
...
async def refresh_access_token(client_id: str, client_secret: str, refresh_token: str) -> Result[str]:
    try:
