...
INTENT_KEYWORDS: Final[dict[str, list[str]]] = {
    ...
    "generar_reporte": ["reporte", "informe", "descargar citas", "obtener reporte", "3"],
    "activar_recordatorios": ["4", "recordatorios"],
    "pregunta_general": ["5", "informacion", "info"],
    "ver_mis_datos": ["mis datos", "datos", "mi perfil", "perfil", "6"],
