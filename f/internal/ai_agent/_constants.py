...
IntentType = Literal[
    ...
    'urgencia', 'pregunta_general', 'saludo', 'despedida', 'agradecimiento',
    'activar_recordatorios', 'desactivar_recordatorios', 'preferencias_recordatorio',
    'mostrar_menu_principal', 'paso_wizard', 'ver_mis_citas', 'desconocido'
]
...
URGENCY_WORDS: Final[list[str]] = ['urgente', 'emergencia', 'urgencia', 'ya mismo', 'ahora mismo', 'inmediato', 'dolor', 'sangrando', 'duele', 'no puedo esperar']
FLEXIBILITY_KEYWORDS: Final[list[str]] = ['cualquier', 'lo que tengas', 'lo que conviene', 'lo que más conviene', 'indistinto', 'flexible', 'lo que tengas disponible']
...
RELATIVE_DATES: Final[list[str]] = ['hoy', 'mañana', 'manana', 'pasado mañana', 'pasado manana', 'esta semana', 'próxima semana', 'la semana que viene']
