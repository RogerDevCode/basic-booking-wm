...
from ..booking_fsm._fsm_models import DraftBooking, BookingStateRoot
...
async def _route(input_data: RouterInput) -> Result[RouterResult, str]:
    ...
    active_flow = cast(Optional[str], state_dict.get("active_flow"))
    ...
    try:
        ...
        if err:
            ...
            return Success(RouterResult(handled=True, response_text="Lo siento, hubo un error procesando tu solicitud."))
